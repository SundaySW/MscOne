...
#define PWM_OUT1_32b_Pin GPIO_PIN_10
#define PWM_OUT1_32b_GPIO_Port GPIOB
#define GPIO_FB_0_Pin GPIO_PIN_11
#define GPIO_FB_0_GPIO_Port GPIOB
#define GPIO_FB_1_Pin GPIO_PIN_12
#define GPIO_FB_1_GPIO_Port GPIOB
#define SS0_Pin GPIO_PIN_13
#define SS0_GPIO_Port GPIOB
#define SS1_Pin GPIO_PIN_14
#define SS1_GPIO_Port GPIOB
#define PWM_OUT2_Pin GPIO_PIN_15
#define PWM_OUT2_GPIO_Port GPIOB
#define GPIO_FB_3A10_Pin GPIO_PIN_10
#define GPIO_FB_3A10_GPIO_Port GPIOA
#define PWM_CPTR1_Pin GPIO_PIN_15
#define PWM_CPTR1_GPIO_Port GPIOA
#define PWM_CPTR2_Pin GPIO_PIN_6
#define PWM_CPTR2_GPIO_Port GPIOB
#define PWM_OUT2B7_Pin GPIO_PIN_7
#define PWM_OUT2B7_GPIO_Port GPIOB
