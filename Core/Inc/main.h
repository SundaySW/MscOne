...
#define GPIO_FB_2_Pin GPIO_PIN_14
#define GPIO_FB_2_GPIO_Port GPIOC
#define GPIO_FB_3_Pin GPIO_PIN_15
#define GPIO_FB_3_GPIO_Port GPIOC
#define ID1_Pin GPIO_PIN_1
#define ID1_GPIO_Port GPIOF
#define LED1_Pin GPIO_PIN_10
#define LED1_GPIO_Port GPIOG
#define DAC_1_1_Pin GPIO_PIN_4
#define DAC_1_1_GPIO_Port GPIOA
#define DAC_1_2_Pin GPIO_PIN_5
#define DAC_1_2_GPIO_Port GPIOA
#define GPIO_CTRL_3_Pin GPIO_PIN_1
...
#define GPIO_FB1_GPIO_Port GPIOB
#define SS0_Pin GPIO_PIN_13
#define SS0_GPIO_Port GPIOB
#define SS1_Pin GPIO_PIN_14
#define SS1_GPIO_Port GPIOB
#define GPIO_CTRL_1_PWM_Pin GPIO_PIN_15
#define GPIO_CTRL_1_PWM_GPIO_Port GPIOB
#define GPIO_IN5_Pin GPIO_PIN_10
#define GPIO_IN5_GPIO_Port GPIOA
#define GPIO_IN7_Pin GPIO_PIN_11
#define GPIO_IN7_GPIO_Port GPIOA
#define GPIO_IN6_Pin GPIO_PIN_12
#define GPIO_IN6_GPIO_Port GPIOA
#define GPIO_IN4_Pin GPIO_PIN_15
#define GPIO_IN4_GPIO_Port GPIOA
#define GPIO_PWM0__Pin GPIO_PIN_6
#define GPIO_PWM0__GPIO_Port GPIOB
#define GPIO_PWM1_Pin GPIO_PIN_7
#define GPIO_PWM1_GPIO_Port GPIOB
